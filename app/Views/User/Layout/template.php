                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="navMenu" class="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg lg:static lg:block lg:max-w-full lg:rounded-none lg:bg-transparent lg:shadow-none dark:bg-slate-700 lg:dark:bg-transparent dark:shadow-slate-400">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#about" class="mx-8 flex py-2 text-base text-dark group-hover:text-primary dark:text-white">BEST SELLER</a>
                            </li>
                            <li class="group">
                                <a href="#portofolio" class="mx-8 flex py-2 text-base text-dark group-hover:text-primary dark:text-white">ALL SHOP</a>
                            </li>
                            <li class="group">
                                <a href="#pengalaman" class="mx-8 flex py-2 text-base text-dark group-hover:text-primary dark:text-white">SOLD OUT</a>
                            </li>
                            <li class="group">
                                <a href="#blog" class="mx-8 flex py-2 text-base text-dark group-hover:text-primary dark:text-white">HOW TO SHOPPING</a>
                            </li>
                            <li class="group">
    ...
    <section id="home" class="pt-20 dark:bg-dark">
        <div class="bg-dark pt-12 pb-12 bg-gradient-to-r from-gray-500 to-gray-900">
            <div class="flex flex-wrap justify-center items-center w-full h-full" id="imgSwich">
                <div class="transition animate-fade-in-down "><img src="/assets/tailwind/img/toko/startOrder.jpg" alt="" class="relative z-10 h-[800px] "></div>
                <div class="transition animate-fade-in-up"><img src="/assets/tailwind/img/toko/foto1.jpg" alt="" class="relative z-10 h-[800px] "></div>
                <div class="transition animate-fade-in-down"><img src="/assets/tailwind/img/toko/foto2.jpg" alt="" class="relative z-10 h-[800px] "></div>
                <div class="transition animate-fade-in-up"><img src="/assets/tailwind/img/toko/foto3.jpg" alt="" class="relative z-10 h-[800px] "></div>
                <div class="transition animate-fade-in-down"><img src="/assets/tailwind/img/toko/foto4.jpg" alt="" class="relative z-10 h-[800px] "></div>
            </div>
        </div>
    </section>
    <!-- Hero Section End -->
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="mb-10 w-full px-4 lg:w-1/2">
                    ...
                    <h2 class="mb-5 max-w-md text-3xl font-bold text-dark lg:text-4xl dark:text-white">Apa Yang Saya Lakukan</h2>
                    <p class="text-base font-medium text-secondary dark:text-secondarybg">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatum impedit beatae consequuntur a qui eligendi debitis iste quis. At, dolor.
                    </p>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="mb-4 text-2xl font-semibold text-dark lg:pt-10 lg:text-3xl dark:text-white">Hubungi saya</h3>
                    <p class="mb-6 text-base font-medium text-secondary dark:text-secondarybg lg:text-lg">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, possimus hic atque voluptas tempore fuga repellat, nesciunt cum incidunt voluptates ducimus odio ipsum, eligendi nisi doloribus itaque aliquam totam dolorem.
                    </p>
