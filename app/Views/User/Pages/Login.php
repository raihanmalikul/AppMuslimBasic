                    ...
                    <div class="mb-10 overflow-hidden rounded-xl bg-white shadow-xl dark:bg-slate-800">
                        <div class="py-8 px-6">
                            <div class="mx-auto text-center">
                                <h2 class="mb-7 text-1xl font-bold text-dark sm:text-2xl lg:text-3xl dark:text-white">Login, Muslim Basic </h2>
                            </div>
                            <form action="/Login/actionLogin" method="post" id="checkLogin">
                                <!-- Email input -->
                                <div class="mb-6 form-group">
                                    <input type="text" class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="email" name="email" placeholder="Email address" autofocus require />
                                </div>
                                ...
                                <div class="text-center lg:text-left">
                                    ...
                                    <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                                        ...
                                        <a href="/register" class="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out">Register</a>
                                    </p>
                                </div>
                            </form>
                        </div>
